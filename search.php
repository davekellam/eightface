	...
	<section id="primary">
		...
		<?php if (have_posts()) : while (have_posts()) : the_post(); ?>		
			<div id="post-<?php the_ID(); ?>" class="post">
				...
				<?php the_excerpt() ?>
				<p>Posted on <?php the_time('F j, Y') ?><?php if ('open' == $post->comment_status || $post->comment_count > 0) : ?> &mdash; <?php comments_popup_link('0 Comments', '1 Comment', '% Comments'); ?><?php endif; ?></p>
				</div>
			...
			<?php global $paged; if($paged != 1) : echo "<span class=\"page-num\">&ndash; " . $paged . " &ndash;</span>" ?>
				<div class="later"><?php previous_posts_link("Later &rarr;"); ?></div>
		<?php else : ?><span class="page-num">&nbsp;</span>
		<?php endif; ?>
	</div>
